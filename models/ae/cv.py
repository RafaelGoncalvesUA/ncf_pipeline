...
ray_results = pd.read_csv('models/ae/ray_results/ray_tune_results.csv').sort_values('eval_loss', ascending=True)
...
num_epochs = 100 # best_config['config/num_epochs']
...
os.makedirs('ae/cv_results', exist_ok=True)

results_df.to_csv(f'ae/cv_results/best.csv', index=False)